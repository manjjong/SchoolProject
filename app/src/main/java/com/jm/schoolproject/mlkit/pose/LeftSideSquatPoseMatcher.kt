...
class LeftSideSquatPoseMatcher : SideSquatPoseMatcher() {
    override val leg: Int = 23

    override fun initTargetPose() {
        targetPose = TargetPose(listOf(
            TargetShape(PoseLandmark.LEFT_HIP, PoseLandmark.LEFT_KNEE, PoseLandmark.LEFT_ANKLE, 85.0, "기준보다 왼쪽 무릎이 펴져있습니다. 왼쪽 무릎을 직각만큼 구부려주세요.", "기준보다 왼쪽 무릎이 구부려져있습니다. 왼쪽 무릎을 직각만큼만 구부려주세요."),
            TargetShape(PoseLandmark.RIGHT_HIP, PoseLandmark.RIGHT_KNEE, PoseLandmark.RIGHT_ANKLE, 170.0, "오른쪽 무릎을 덜 펴주세요.", "기준보다 오른쪽 무릎이 구부려져있습니다. 오른쪽 다리를 펴주세요."),
        ))
    }
