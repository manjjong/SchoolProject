...
class RightSideSquatPoseMatcher : SideSquatPoseMatcher() {
    ...
    override fun initTargetPose() {
        targetPose = TargetPose(listOf(
            TargetShape(PoseLandmark.LEFT_HIP, PoseLandmark.LEFT_KNEE, PoseLandmark.LEFT_ANKLE, 180.0, "왼쪽 무릎을 조금 더 굽혀주세요.", "왼쪽 무릎을 조금 더 펴주세요."),
            TargetShape(PoseLandmark.RIGHT_HIP, PoseLandmark.RIGHT_KNEE, PoseLandmark.RIGHT_ANKLE, 85.0, "오른쪽 무릎을 조금 더 굽혀 주세요.", "오른쪽 무릎을 조금 더 펴주세요."),
        ))
    }
